      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {/* Prominent AI Suggestions Button - Above textarea */}
            {!formData.goal && (
              <motion.div
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mb-3 p-4 bg-gradient-to-r from-[#00F0FF]/10 to-[#FF00B8]/10 rounded-lg border border-[#00F0FF]/30"
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="text-[#EAEAEA] font-medium flex items-center gap-2">
                        <svg className="w-5 h-5 text-[#00F0FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-[#EAEAEA]/70 text-sm mb-2">
                      {formData.industry 
                        ? `Let AI suggest proven campaign goals specifically for ${formData.industry.toLowerCase()} businesses`
                        : 'Let AI suggest proven campaign goals tailored to your business'
                      }
                    </p>
                    <div className="flex items-center gap-4 text-xs text-[#EAEAEA]/60">
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 bg-[#00F0FF] text-[#1A1A1A] rounded-lg font-semibold hover:bg-[#FF00B8] transition-all duration-200 hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] flex items-center gap-2 whitespace-nowrap"
            ...
            <div className="relative">
              <textarea
                ...
                placeholder={formData.industry 
                  ? `💡 Click "Get AI Suggestions" above for proven ${formData.industry.toLowerCase()} campaign ideas, or describe your campaign goal here...`
                  : "💡 Click \"Get AI Suggestions\" above for campaign ideas, or describe your goal here..."
                }
              />
              {errors.goal && (
              ...
              {/* Secondary AI Suggestions Toggle - Smaller, below textarea */}
              {formData.goal && (
                <div className="flex items-center justify-between mt-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-[#00F0FF]/10 text-[#00F0FF] rounded-lg border border-[#00F0FF]/30 hover:bg-[#00F0FF]/20 hover:text-[#FF00B8] transition-all duration-200 text-sm font-medium"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
