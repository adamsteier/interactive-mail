      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            exit={{ y: -20, opacity: 0 }}
            className="relative w-full max-w-md rounded-lg border-2 border-electric-teal bg-charcoal p-6 shadow-glow"
          >
            {/* Logo or Header */}
            <div className="mb-6 text-center">
              ...
              <p className="text-electric-teal/70">
                {mode === 'signin' 
                  ? 'Sign in to view your marketing leads' 
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center mt-4">
                <button
                  type="button"
                  onClick={switchMode}
                  className="text-electric-teal hover:text-electric-teal/80 text-sm"
                >
                  {mode === 'signin' 
